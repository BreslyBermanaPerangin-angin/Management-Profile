...
<section class="content">
    <div class="container-fluid">
        <div class="card card-primary">
            ...
            <form action="<?= base_url('/profile/update/' . $profile['id']) ?>" method="post"
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" name="name" id="name" class="form-control" value="<?=
                            esc($profile['name']) ?>" required>
                    </div>
                    <div class="form-group">
                        <label for="email">Email</label>
                        <input type="email" name="email" id="email" class="form-control" value="<?=
                            esc($profile['email']) ?>" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <?php if ($profile['photo']): ?>
                            <img src="<?= base_url('uploads/photos/' . $profile['photo']) ?>" class="imgthumbnail mb-2"
                                width="120">
                        <?php else: ?>
                ...
                <div class="card-footer">
                    <button type="submit" class="btn btn-success"><i class="fas fa-save"></i>
                        Update</button>
                    <a href="<?= base_url('/profile') ?>" class="btn btn-secondary"><i class="fas fa-arrowleft"></i>
                        Batal</a>
                </div>
            </form>
        </div>
